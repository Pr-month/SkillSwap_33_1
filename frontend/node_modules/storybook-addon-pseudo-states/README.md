### ❗The addon has been [merged to Storybook monorepo](https://github.com/storybookjs/storybook/tree/next/code/addons/pseudo-states), and this repo is now a public archive.
